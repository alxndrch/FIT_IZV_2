...
def get_dataframe(filename: str = "accidents.pkl.gz", verbose: bool = False) -> pd.DataFrame:
    ...
    category_col = ["p36", "p6", "p7", "p8", "p9", "p10", "p11", "p15", "p16", "p17", "p18", 
                    "p19", "p20", "p21", "p22", "p23", "p24", "p27", "p28", "p39", "p44", 
                    "p45a", "p48a", "p49", "p50a", "p50b", "p51", "p55a", "p57", "p58", "p5a", "t"]
        
    if verbose: print("orig_size={:.1f} MB".format(df.memory_usage(deep=True).sum() / MB))
    ...
    if verbose: print("new_size={:.1f} MB".format(df.memory_usage(deep=True).sum() / MB))
